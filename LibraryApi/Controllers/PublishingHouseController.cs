...
namespace LibraryApi.Controllers
{
    ...
    public class PublishingHouseController : ControllerBase
    {
        ...
        {
            var publishingHouse = await _publishingHouseService.GetAllPublishingHouses();

            return ResultModel<IEnumerable<PublishingHouseDto>>.ToActionResult(publishingHouse);
        }
    }
}
